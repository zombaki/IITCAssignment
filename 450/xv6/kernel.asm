...
80100a6a:	75 cf                	jne    80100a3b <exec+0x4b>
  ...
  if((pgdir = setupkvm()) == 0)
80100a6c:	e8 ff 5e 00 00       	call   80106970 <setupkvm>
...
80100b91:	e8 6a 60 00 00       	call   80106c00 <allocuvm>
...
80100ba8:	e8 83 61 00 00       	call   80106d30 <freevm>
...
80100bdd:	e8 ce 61 00 00       	call   80106db0 <clearpteu>
  sp = sz;
...
80100c35:	e8 d6 62 00 00       	call   80106f10 <copyout>
...
80100c99:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c9f:	e8 6c 62 00 00       	call   80106f10 <copyout>
...
80100d19:	e8 02 5d 00 00       	call   80106a20 <switchuvm>
  freevm(oldpgdir);
80100d1e:	89 3c 24             	mov    %edi,(%esp)
80100d21:	e8 0a 60 00 00       	call   80106d30 <freevm>
  return 0;
...
80102e89:	e8 62 29 00 00       	call   801057f0 <idtinit>
...
80102eb3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102eb6:	e8 45 3b 00 00       	call   80106a00 <switchkvm>
  seginit();
80102ebb:	e8 60 39 00 00       	call   80106820 <seginit>
  lapicinit();
...
80102f26:	e8 c5 2b 00 00       	call   80105af0 <uartinit>
  pinit();         // process table
80102f2b:	e8 30 09 00 00       	call   80103860 <pinit>
  tvinit();        // trap vectors
80102f30:	e8 1b 28 00 00       	call   80105750 <tvinit>
  binit();         // buffer cache
...
8010301a:	e8 51 fe ff ff       	call   80102e70 <mpmain>
  ...
  if(!ismp)
    timerinit();   // uniprocessor timer
8010301f:	e8 cc 26 00 00       	call   801056f0 <timerinit>
...
801037c4:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
801037c7:	c7 40 14 3e 57 10 80 	movl   $0x8010573e,0x14(%eax)
...
80103866:	68 0d 75 10 80       	push   $0x8010750d
...
80103893:	e8 d8 30 00 00       	call   80106970 <setupkvm>
...
801038b1:	e8 0a 32 00 00       	call   80106ac0 <inituvm>
  p->sz = PGSIZE;
...
8010391f:	68 2d 75 10 80       	push   $0x8010752d
80103924:	50                   	push   %eax
80103925:	e8 66 0d 00 00       	call   80104690 <safestrcpy>
  p->cwd = namei("/");
8010392a:	c7 04 24 36 75 10 80 	movl   $0x80107536,(%esp)
...
80103963:	68 14 75 10 80       	push   $0x80107514
...
80103991:	e8 6a 32 00 00       	call   80106c00 <allocuvm>
...
801039b0:	e8 6b 30 00 00       	call   80106a20 <switchuvm>
  return 0;
...
801039cc:	e8 2f 33 00 00       	call   80106d00 <deallocuvm>
...
80103a06:	e8 d5 33 00 00       	call   80106de0 <copyuvm>
...
80103b4c:	83 c3 7c             	add    $0x7c,%ebx
      ...
      proc = p;
      switchuvm(p);
80103b4f:	e8 cc 2e 00 00       	call   80106a20 <switchuvm>
      p->state = RUNNING;
...
80103b6a:	e8 7c 0b 00 00       	call   801046eb <swtch>
      switchkvm();
80103b6f:	e8 8c 2e 00 00       	call   80106a00 <switchkvm>
...
80103c17:	68 38 75 10 80       	push   $0x80107538
...
80103c24:	68 64 75 10 80       	push   $0x80107564
...
80103c31:	68 56 75 10 80       	push   $0x80107556
...
80103c3e:	68 4a 75 10 80       	push   $0x8010754a
...
80103d7d:	68 85 75 10 80       	push   $0x80107585
...
80103d8a:	68 78 75 10 80       	push   $0x80107578
...
80103e86:	68 97 75 10 80       	push   $0x80107597
...
80103e93:	68 91 75 10 80       	push   $0x80107591
...
80103f20:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f27:	e8 04 2e 00 00       	call   80106d30 <freevm>
        p->pid = 0;
...
8010408b:	68 e6 74 10 80       	push   $0x801074e6
...
801040ae:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
801040b1:	ba a8 75 10 80       	mov    $0x801075a8,%edx
  uint pc[10];
...
801040b8:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801040bf:	b8 a8 75 10 80       	mov    $0x801075a8,%eax
...
801040ce:	68 ac 75 10 80       	push   $0x801075ac
...
8010410d:	68 09 70 10 80       	push   $0x80107009
...
8010413a:	68 f8 75 10 80       	push   $0x801075f8
...
8010431b:	68 03 76 10 80       	push   $0x80107603
...
8010441f:	68 22 76 10 80       	push   $0x80107622
...
8010442c:	68 0b 76 10 80       	push   $0x8010760b
...
8010445e:	68 29 76 10 80       	push   $0x80107629
...
extern int syscallnum;//Global declared variable
...
80104890 <syscall>:
[SYS_getUserTraps] sys_getUserTraps,
};
...
801048a7:	83 f9 16             	cmp    $0x16,%ecx
801048aa:	77 24                	ja     801048d0 <syscall+0x40>
801048ac:	8b 0c 85 60 76 10 80 	mov    -0x7fef89a0(,%eax,4),%ecx
801048b3:	85 c9                	test   %ecx,%ecx
801048b5:	74 19                	je     801048d0 <syscall+0x40>
	syscallnum++;//This will have total count of system calls
801048b7:	83 05 0c a0 10 80 01 	addl   $0x1,0x8010a00c
    proc->tf->eax = syscalls[num]();
801048be:	ff d1                	call   *%ecx
801048c0:	89 43 1c             	mov    %eax,0x1c(%ebx)
  } else {
...
801048d0:	50                   	push   %eax
            proc->pid, proc->name, num);
801048d1:	8d 42 6c             	lea    0x6c(%edx),%eax
  num = proc->tf->eax;
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
	syscallnum++;//This will have total count of system calls
    proc->tf->eax = syscalls[num]();
...
801048d5:	ff 72 10             	pushl  0x10(%edx)
801048d8:	68 31 76 10 80       	push   $0x80107631
801048dd:	e8 7e bd ff ff       	call   80100660 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801048e2:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801048e8:	83 c4 10             	add    $0x10,%esp
801048eb:	8b 40 18             	mov    0x18(%eax),%eax
801048ee:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
...
80104a71:	68 cf 76 10 80       	push   $0x801076cf
...
80104a7e:	68 de 76 10 80       	push   $0x801076de
...
80104a8b:	68 c0 76 10 80       	push   $0x801076c0
...
80104e8d:	58                   	pop    %eax
80104e8e:	5a                   	pop    %edx
80104e8f:	68 dc 76 10 80       	push   $0x801076dc
...
80104ea8:	68 db 76 10 80       	push   $0x801076db
...
80104ffd:	68 00 77 10 80       	push   $0x80107700
...
8010500a:	68 12 77 10 80       	push   $0x80107712
...
80105017:	68 ee 76 10 80       	push   $0x801076ee
...
80105686:	8d 45 08             	lea    0x8(%ebp),%eax
80105689:	50                   	push   %eax
8010568a:	6a 00                	push   $0x0
8010568c:	e8 ef f0 ff ff       	call   80104780 <argint>
	
	if (ticks>initialTicks)
80105691:	8b 0d 20 55 11 80    	mov    0x80115520,%ecx
...
801056a0:	29 d0                	sub    %edx,%eax
801056a2:	39 d1                	cmp    %edx,%ecx
801056a4:	ba 00 00 00 00       	mov    $0x0,%edx
801056a9:	0f 46 c2             	cmovbe %edx,%eax
	else
		return 0;//This will only return in case of some disruption.
...
801056c9:	74 0d                	je     801056d8 <sys_getUserTraps+0x28>
	{
		...
		return syscallnum;
801056cb:	a1 0c a0 10 80       	mov    0x8010a00c,%eax
}
801056d0:	c9                   	leave  
801056d1:	c3                   	ret    
...
sys_getUserTraps(int intState)
{
	...
	{
		syscallnum=0;
801056d8:	c7 05 0c a0 10 80 00 	movl   $0x0,0x8010a00c
801056df:	00 00 00 
		return 0;
	}
	else
...
80105714:	e8 77 db ff ff       	call   80103290 <picenable>
}
...
{
  int i;
	//trapCallNum =0;//Initialized Global Variable trapCallNum with 0
...
uint ticks;
//extern int trapCallNum;//Global declared variable
...
801057a9:	68 21 77 10 80       	push   $0x80107721
...
801057d1:	66 a3 26 4f 11 80    	mov    %ax,0x80114f26
  ...
  initlock(&tickslock, "time");
801057d7:	e8 64 ea ff ff       	call   80104240 <initlock>
}
...
80105829:	8b 5d 08             	mov    0x8(%ebp),%ebx
   //trapCallNum++;//Increment trap call each time a trap is invoked
...
80105840:	ff 24 85 c8 77 10 80 	jmp    *-0x7fef8838(,%eax,4)
80105847:	89 f6                	mov    %esi,%esi
80105849:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
80105850:	e8 8b ce ff ff       	call   801026e0 <cpunum>
80105855:	85 c0                	test   %eax,%eax
80105857:	0f 84 b3 01 00 00    	je     80105a10 <trap+0x1f0>
    kbdintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_COM1:
    uartintr();
    lapiceoi();
8010585d:	e8 1e cf ff ff       	call   80102780 <lapiceoi>
  }
...
801058b1:	0f 84 8d 01 00 00    	je     80105a44 <trap+0x224>
801058b7:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801058bb:	0f 84 83 01 00 00    	je     80105a44 <trap+0x224>
...
801058c7:	e8 14 ce ff ff       	call   801026e0 <cpunum>
...
801058e3:	68 84 77 10 80       	push   $0x80107784
...
80105908:	0f 85 69 ff ff ff    	jne    80105877 <trap+0x57>
    exit();
8010590e:	e8 3d e3 ff ff       	call   80103c50 <exit>
...
8010591b:	0f 85 56 ff ff ff    	jne    80105877 <trap+0x57>
80105921:	e9 73 ff ff ff       	jmp    80105899 <trap+0x79>
...
80105960:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit();
80105961:	e9 ea e2 ff ff       	jmp    80103c50 <exit>
...
80105974:	0f 85 07 ff ff ff    	jne    80105881 <trap+0x61>
    yield();
8010597a:	e8 21 e4 ff ff       	call   80103da0 <yield>
...
80105992:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105998:	e8 23 cc ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
8010599d:	e8 de cd ff ff       	call   80102780 <lapiceoi>
    break;
...
801059a9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801059b0:	e8 2b 02 00 00       	call   80105be0 <uartintr>
...
801059c7:	e8 14 cd ff ff       	call   801026e0 <cpunum>
801059cc:	57                   	push   %edi
801059cd:	56                   	push   %esi
801059ce:	50                   	push   %eax
801059cf:	68 2c 77 10 80       	push   $0x8010772c
801059d4:	e8 87 ac ff ff       	call   80100660 <cprintf>
            cpunum(), tf->cs, tf->eip);
    lapiceoi();
801059d9:	e8 a2 cd ff ff       	call   80102780 <lapiceoi>
    break;
...
801059e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801059f0:	e8 3b c6 ff ff       	call   80102030 <ideintr>
    lapiceoi();
...
80105a0b:	e9 31 ff ff ff       	jmp    80105941 <trap+0x121>
  }
...
80105a18:	e8 43 e8 ff ff       	call   80104260 <acquire>
      ticks++;
      wakeup(&ticks);
80105a1d:	c7 04 24 20 55 11 80 	movl   $0x80115520,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
      ticks++;
80105a24:	83 05 20 55 11 80 01 	addl   $0x1,0x80115520
      wakeup(&ticks);
80105a2b:	e8 50 e5 ff ff       	call   80103f80 <wakeup>
      release(&tickslock);
80105a30:	c7 04 24 e0 4c 11 80 	movl   $0x80114ce0,(%esp)
80105a37:	e8 04 ea ff ff       	call   80104440 <release>
80105a3c:	83 c4 10             	add    $0x10,%esp
80105a3f:	e9 19 fe ff ff       	jmp    8010585d <trap+0x3d>
...
80105a4a:	e8 91 cc ff ff       	call   801026e0 <cpunum>
...
80105a58:	68 50 77 10 80       	push   $0x80107750
80105a5d:	e8 fe ab ff ff       	call   80100660 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105a62:	83 c4 14             	add    $0x14,%esp
80105a65:	68 26 77 10 80       	push   $0x80107726
...
80105ac5:	e8 d6 cc ff ff       	call   801027a0 <microdelay>
{
  int i;
...
80105b61:	e8 2a d7 ff ff       	call   80103290 <picenable>
  ioapicenable(IRQ_COM1, 0);
80105b66:	59                   	pop    %ecx
80105b67:	5b                   	pop    %ebx
80105b68:	6a 00                	push   $0x0
80105b6a:	6a 04                	push   $0x4
80105b6c:	bb 48 78 10 80       	mov    $0x80107848,%ebx
80105b71:	e8 1a c7 ff ff       	call   80102290 <ioapicenable>
80105b76:	83 c4 10             	add    $0x10,%esp
80105b79:	b8 78 00 00 00       	mov    $0x78,%eax
80105b7e:	eb 0a                	jmp    80105b8a <uartinit+0x9a>
...
uartputc(int c)
{
  ...
  if(!uart)
80105b8a:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105bb0:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
    uartputc(*p);
}
...
80105bf7:	6a 00                	push   $0x0
  jmp alltraps
80105bf9:	e9 20 fb ff ff       	jmp    8010571e <alltraps>
...
80105c00:	6a 01                	push   $0x1
  jmp alltraps
80105c02:	e9 17 fb ff ff       	jmp    8010571e <alltraps>
...
80105c09:	6a 02                	push   $0x2
  jmp alltraps
80105c0b:	e9 0e fb ff ff       	jmp    8010571e <alltraps>
...
80105c12:	6a 03                	push   $0x3
  jmp alltraps
80105c14:	e9 05 fb ff ff       	jmp    8010571e <alltraps>
...
80105c1b:	6a 04                	push   $0x4
  jmp alltraps
80105c1d:	e9 fc fa ff ff       	jmp    8010571e <alltraps>
...
80105c24:	6a 05                	push   $0x5
  jmp alltraps
80105c26:	e9 f3 fa ff ff       	jmp    8010571e <alltraps>
...
80105c2d:	6a 06                	push   $0x6
  jmp alltraps
80105c2f:	e9 ea fa ff ff       	jmp    8010571e <alltraps>
...
80105c36:	6a 07                	push   $0x7
  jmp alltraps
80105c38:	e9 e1 fa ff ff       	jmp    8010571e <alltraps>
...
80105c54:	6a 0b                	push   $0xb
  jmp alltraps
80105c56:	e9 c3 fa ff ff       	jmp    8010571e <alltraps>
...
80105c5b:	6a 0c                	push   $0xc
  jmp alltraps
80105c5d:	e9 bc fa ff ff       	jmp    8010571e <alltraps>
...
80105c62:	6a 0d                	push   $0xd
  jmp alltraps
80105c64:	e9 b5 fa ff ff       	jmp    8010571e <alltraps>
...
80105c69:	6a 0e                	push   $0xe
  jmp alltraps
80105c6b:	e9 ae fa ff ff       	jmp    8010571e <alltraps>
...
80105c7b:	6a 10                	push   $0x10
  jmp alltraps
80105c7d:	e9 9c fa ff ff       	jmp    8010571e <alltraps>
...
80105c94:	6a 13                	push   $0x13
  jmp alltraps
80105c96:	e9 83 fa ff ff       	jmp    8010571e <alltraps>
...
80105c9d:	6a 14                	push   $0x14
  jmp alltraps
80105c9f:	e9 7a fa ff ff       	jmp    8010571e <alltraps>
...
80105ca6:	6a 15                	push   $0x15
  jmp alltraps
80105ca8:	e9 71 fa ff ff       	jmp    8010571e <alltraps>
...
80105caf:	6a 16                	push   $0x16
  jmp alltraps
80105cb1:	e9 68 fa ff ff       	jmp    8010571e <alltraps>
...
80105cb8:	6a 17                	push   $0x17
  jmp alltraps
80105cba:	e9 5f fa ff ff       	jmp    8010571e <alltraps>
...
80105cc1:	6a 18                	push   $0x18
  jmp alltraps
80105cc3:	e9 56 fa ff ff       	jmp    8010571e <alltraps>
...
80105cca:	6a 19                	push   $0x19
  jmp alltraps
80105ccc:	e9 4d fa ff ff       	jmp    8010571e <alltraps>
...
80105cd3:	6a 1a                	push   $0x1a
  jmp alltraps
80105cd5:	e9 44 fa ff ff       	jmp    8010571e <alltraps>
...
80105cdc:	6a 1b                	push   $0x1b
  jmp alltraps
80105cde:	e9 3b fa ff ff       	jmp    8010571e <alltraps>
...
80105ce5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ce7:	e9 32 fa ff ff       	jmp    8010571e <alltraps>
...
80105cee:	6a 1d                	push   $0x1d
  jmp alltraps
80105cf0:	e9 29 fa ff ff       	jmp    8010571e <alltraps>
...
80105cf7:	6a 1e                	push   $0x1e
  jmp alltraps
80105cf9:	e9 20 fa ff ff       	jmp    8010571e <alltraps>
...
80105d00:	6a 1f                	push   $0x1f
  jmp alltraps
80105d02:	e9 17 fa ff ff       	jmp    8010571e <alltraps>
...
80105d09:	6a 20                	push   $0x20
  jmp alltraps
80105d0b:	e9 0e fa ff ff       	jmp    8010571e <alltraps>
...
80105d12:	6a 21                	push   $0x21
  jmp alltraps
80105d14:	e9 05 fa ff ff       	jmp    8010571e <alltraps>
...
80105d1b:	6a 22                	push   $0x22
  jmp alltraps
80105d1d:	e9 fc f9 ff ff       	jmp    8010571e <alltraps>
...
80105d24:	6a 23                	push   $0x23
  jmp alltraps
80105d26:	e9 f3 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d2d:	6a 24                	push   $0x24
  jmp alltraps
80105d2f:	e9 ea f9 ff ff       	jmp    8010571e <alltraps>
...
80105d36:	6a 25                	push   $0x25
  jmp alltraps
80105d38:	e9 e1 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d3f:	6a 26                	push   $0x26
  jmp alltraps
80105d41:	e9 d8 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d48:	6a 27                	push   $0x27
  jmp alltraps
80105d4a:	e9 cf f9 ff ff       	jmp    8010571e <alltraps>
...
80105d51:	6a 28                	push   $0x28
  jmp alltraps
80105d53:	e9 c6 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d5a:	6a 29                	push   $0x29
  jmp alltraps
80105d5c:	e9 bd f9 ff ff       	jmp    8010571e <alltraps>
...
80105d63:	6a 2a                	push   $0x2a
  jmp alltraps
80105d65:	e9 b4 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d6c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d6e:	e9 ab f9 ff ff       	jmp    8010571e <alltraps>
...
80105d75:	6a 2c                	push   $0x2c
  jmp alltraps
80105d77:	e9 a2 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d7e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d80:	e9 99 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d87:	6a 2e                	push   $0x2e
  jmp alltraps
80105d89:	e9 90 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d90:	6a 2f                	push   $0x2f
  jmp alltraps
80105d92:	e9 87 f9 ff ff       	jmp    8010571e <alltraps>
...
80105d99:	6a 30                	push   $0x30
  jmp alltraps
80105d9b:	e9 7e f9 ff ff       	jmp    8010571e <alltraps>
...
80105da2:	6a 31                	push   $0x31
  jmp alltraps
80105da4:	e9 75 f9 ff ff       	jmp    8010571e <alltraps>
...
80105dab:	6a 32                	push   $0x32
  jmp alltraps
80105dad:	e9 6c f9 ff ff       	jmp    8010571e <alltraps>
...
80105db4:	6a 33                	push   $0x33
  jmp alltraps
80105db6:	e9 63 f9 ff ff       	jmp    8010571e <alltraps>
...
80105dbd:	6a 34                	push   $0x34
  jmp alltraps
80105dbf:	e9 5a f9 ff ff       	jmp    8010571e <alltraps>
...
80105dc6:	6a 35                	push   $0x35
  jmp alltraps
80105dc8:	e9 51 f9 ff ff       	jmp    8010571e <alltraps>
...
80105dcf:	6a 36                	push   $0x36
  jmp alltraps
80105dd1:	e9 48 f9 ff ff       	jmp    8010571e <alltraps>
...
80105dd8:	6a 37                	push   $0x37
  jmp alltraps
80105dda:	e9 3f f9 ff ff       	jmp    8010571e <alltraps>
...
80105de1:	6a 38                	push   $0x38
  jmp alltraps
80105de3:	e9 36 f9 ff ff       	jmp    8010571e <alltraps>
...
80105dea:	6a 39                	push   $0x39
  jmp alltraps
80105dec:	e9 2d f9 ff ff       	jmp    8010571e <alltraps>
...
80105df3:	6a 3a                	push   $0x3a
  jmp alltraps
80105df5:	e9 24 f9 ff ff       	jmp    8010571e <alltraps>
...
80105dfc:	6a 3b                	push   $0x3b
  jmp alltraps
80105dfe:	e9 1b f9 ff ff       	jmp    8010571e <alltraps>
...
80105e05:	6a 3c                	push   $0x3c
  jmp alltraps
80105e07:	e9 12 f9 ff ff       	jmp    8010571e <alltraps>
...
80105e0e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e10:	e9 09 f9 ff ff       	jmp    8010571e <alltraps>
...
80105e17:	6a 3e                	push   $0x3e
  jmp alltraps
80105e19:	e9 00 f9 ff ff       	jmp    8010571e <alltraps>
...
80105e20:	6a 3f                	push   $0x3f
  jmp alltraps
80105e22:	e9 f7 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e29:	6a 40                	push   $0x40
  jmp alltraps
80105e2b:	e9 ee f8 ff ff       	jmp    8010571e <alltraps>
...
80105e32:	6a 41                	push   $0x41
  jmp alltraps
80105e34:	e9 e5 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e3b:	6a 42                	push   $0x42
  jmp alltraps
80105e3d:	e9 dc f8 ff ff       	jmp    8010571e <alltraps>
...
80105e44:	6a 43                	push   $0x43
  jmp alltraps
80105e46:	e9 d3 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e4d:	6a 44                	push   $0x44
  jmp alltraps
80105e4f:	e9 ca f8 ff ff       	jmp    8010571e <alltraps>
...
80105e56:	6a 45                	push   $0x45
  jmp alltraps
80105e58:	e9 c1 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e5f:	6a 46                	push   $0x46
  jmp alltraps
80105e61:	e9 b8 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e68:	6a 47                	push   $0x47
  jmp alltraps
80105e6a:	e9 af f8 ff ff       	jmp    8010571e <alltraps>
...
80105e71:	6a 48                	push   $0x48
  jmp alltraps
80105e73:	e9 a6 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e7a:	6a 49                	push   $0x49
  jmp alltraps
80105e7c:	e9 9d f8 ff ff       	jmp    8010571e <alltraps>
...
80105e83:	6a 4a                	push   $0x4a
  jmp alltraps
80105e85:	e9 94 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e8c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e8e:	e9 8b f8 ff ff       	jmp    8010571e <alltraps>
...
80105e95:	6a 4c                	push   $0x4c
  jmp alltraps
80105e97:	e9 82 f8 ff ff       	jmp    8010571e <alltraps>
...
80105e9e:	6a 4d                	push   $0x4d
  jmp alltraps
80105ea0:	e9 79 f8 ff ff       	jmp    8010571e <alltraps>
...
80105ea7:	6a 4e                	push   $0x4e
  jmp alltraps
80105ea9:	e9 70 f8 ff ff       	jmp    8010571e <alltraps>
...
80105eb0:	6a 4f                	push   $0x4f
  jmp alltraps
80105eb2:	e9 67 f8 ff ff       	jmp    8010571e <alltraps>
...
80105eb9:	6a 50                	push   $0x50
  jmp alltraps
80105ebb:	e9 5e f8 ff ff       	jmp    8010571e <alltraps>
...
80105ec2:	6a 51                	push   $0x51
  jmp alltraps
80105ec4:	e9 55 f8 ff ff       	jmp    8010571e <alltraps>
...
80105ecb:	6a 52                	push   $0x52
  jmp alltraps
80105ecd:	e9 4c f8 ff ff       	jmp    8010571e <alltraps>
...
80105ed4:	6a 53                	push   $0x53
  jmp alltraps
80105ed6:	e9 43 f8 ff ff       	jmp    8010571e <alltraps>
...
80105edd:	6a 54                	push   $0x54
  jmp alltraps
80105edf:	e9 3a f8 ff ff       	jmp    8010571e <alltraps>
...
80105ee6:	6a 55                	push   $0x55
  jmp alltraps
80105ee8:	e9 31 f8 ff ff       	jmp    8010571e <alltraps>
...
80105eef:	6a 56                	push   $0x56
  jmp alltraps
80105ef1:	e9 28 f8 ff ff       	jmp    8010571e <alltraps>
...
80105ef8:	6a 57                	push   $0x57
  jmp alltraps
80105efa:	e9 1f f8 ff ff       	jmp    8010571e <alltraps>
...
80105f01:	6a 58                	push   $0x58
  jmp alltraps
80105f03:	e9 16 f8 ff ff       	jmp    8010571e <alltraps>
...
80105f0a:	6a 59                	push   $0x59
  jmp alltraps
80105f0c:	e9 0d f8 ff ff       	jmp    8010571e <alltraps>
...
80105f13:	6a 5a                	push   $0x5a
  jmp alltraps
80105f15:	e9 04 f8 ff ff       	jmp    8010571e <alltraps>
...
80105f1c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f1e:	e9 fb f7 ff ff       	jmp    8010571e <alltraps>
...
80105f25:	6a 5c                	push   $0x5c
  jmp alltraps
80105f27:	e9 f2 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f2e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f30:	e9 e9 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f37:	6a 5e                	push   $0x5e
  jmp alltraps
80105f39:	e9 e0 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f40:	6a 5f                	push   $0x5f
  jmp alltraps
80105f42:	e9 d7 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f49:	6a 60                	push   $0x60
  jmp alltraps
80105f4b:	e9 ce f7 ff ff       	jmp    8010571e <alltraps>
...
80105f52:	6a 61                	push   $0x61
  jmp alltraps
80105f54:	e9 c5 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f5b:	6a 62                	push   $0x62
  jmp alltraps
80105f5d:	e9 bc f7 ff ff       	jmp    8010571e <alltraps>
...
80105f64:	6a 63                	push   $0x63
  jmp alltraps
80105f66:	e9 b3 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f6d:	6a 64                	push   $0x64
  jmp alltraps
80105f6f:	e9 aa f7 ff ff       	jmp    8010571e <alltraps>
...
80105f76:	6a 65                	push   $0x65
  jmp alltraps
80105f78:	e9 a1 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f7f:	6a 66                	push   $0x66
  jmp alltraps
80105f81:	e9 98 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f88:	6a 67                	push   $0x67
  jmp alltraps
80105f8a:	e9 8f f7 ff ff       	jmp    8010571e <alltraps>
...
80105f91:	6a 68                	push   $0x68
  jmp alltraps
80105f93:	e9 86 f7 ff ff       	jmp    8010571e <alltraps>
...
80105f9a:	6a 69                	push   $0x69
  jmp alltraps
80105f9c:	e9 7d f7 ff ff       	jmp    8010571e <alltraps>
...
80105fa3:	6a 6a                	push   $0x6a
  jmp alltraps
80105fa5:	e9 74 f7 ff ff       	jmp    8010571e <alltraps>
...
80105fac:	6a 6b                	push   $0x6b
  jmp alltraps
80105fae:	e9 6b f7 ff ff       	jmp    8010571e <alltraps>
...
80105fb5:	6a 6c                	push   $0x6c
  jmp alltraps
80105fb7:	e9 62 f7 ff ff       	jmp    8010571e <alltraps>
...
80105fbe:	6a 6d                	push   $0x6d
  jmp alltraps
80105fc0:	e9 59 f7 ff ff       	jmp    8010571e <alltraps>
...
80105fc7:	6a 6e                	push   $0x6e
  jmp alltraps
80105fc9:	e9 50 f7 ff ff       	jmp    8010571e <alltraps>
...
80105fd0:	6a 6f                	push   $0x6f
  jmp alltraps
80105fd2:	e9 47 f7 ff ff       	jmp    8010571e <alltraps>
...
80105fd9:	6a 70                	push   $0x70
  jmp alltraps
80105fdb:	e9 3e f7 ff ff       	jmp    8010571e <alltraps>
...
80105fe2:	6a 71                	push   $0x71
  jmp alltraps
80105fe4:	e9 35 f7 ff ff       	jmp    8010571e <alltraps>
...
80105feb:	6a 72                	push   $0x72
  jmp alltraps
80105fed:	e9 2c f7 ff ff       	jmp    8010571e <alltraps>
...
80105ff4:	6a 73                	push   $0x73
  jmp alltraps
80105ff6:	e9 23 f7 ff ff       	jmp    8010571e <alltraps>
...
80105ffd:	6a 74                	push   $0x74
  jmp alltraps
80105fff:	e9 1a f7 ff ff       	jmp    8010571e <alltraps>
...
80106006:	6a 75                	push   $0x75
  jmp alltraps
80106008:	e9 11 f7 ff ff       	jmp    8010571e <alltraps>
...
8010600f:	6a 76                	push   $0x76
  jmp alltraps
80106011:	e9 08 f7 ff ff       	jmp    8010571e <alltraps>
...
80106018:	6a 77                	push   $0x77
  jmp alltraps
8010601a:	e9 ff f6 ff ff       	jmp    8010571e <alltraps>
...
80106021:	6a 78                	push   $0x78
  jmp alltraps
80106023:	e9 f6 f6 ff ff       	jmp    8010571e <alltraps>
...
8010602a:	6a 79                	push   $0x79
  jmp alltraps
8010602c:	e9 ed f6 ff ff       	jmp    8010571e <alltraps>
...
80106033:	6a 7a                	push   $0x7a
  jmp alltraps
80106035:	e9 e4 f6 ff ff       	jmp    8010571e <alltraps>
...
8010603c:	6a 7b                	push   $0x7b
  jmp alltraps
8010603e:	e9 db f6 ff ff       	jmp    8010571e <alltraps>
...
80106045:	6a 7c                	push   $0x7c
  jmp alltraps
80106047:	e9 d2 f6 ff ff       	jmp    8010571e <alltraps>
...
8010604e:	6a 7d                	push   $0x7d
  jmp alltraps
80106050:	e9 c9 f6 ff ff       	jmp    8010571e <alltraps>
...
80106057:	6a 7e                	push   $0x7e
  jmp alltraps
80106059:	e9 c0 f6 ff ff       	jmp    8010571e <alltraps>
...
80106060:	6a 7f                	push   $0x7f
  jmp alltraps
80106062:	e9 b7 f6 ff ff       	jmp    8010571e <alltraps>
...
80106069:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010606e:	e9 ab f6 ff ff       	jmp    8010571e <alltraps>
...
80106075:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010607a:	e9 9f f6 ff ff       	jmp    8010571e <alltraps>
...
80106081:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106086:	e9 93 f6 ff ff       	jmp    8010571e <alltraps>
...
8010608d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106092:	e9 87 f6 ff ff       	jmp    8010571e <alltraps>
...
80106099:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010609e:	e9 7b f6 ff ff       	jmp    8010571e <alltraps>
...
801060a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801060aa:	e9 6f f6 ff ff       	jmp    8010571e <alltraps>
...
801060b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801060b6:	e9 63 f6 ff ff       	jmp    8010571e <alltraps>
...
801060bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801060c2:	e9 57 f6 ff ff       	jmp    8010571e <alltraps>
...
801060c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801060ce:	e9 4b f6 ff ff       	jmp    8010571e <alltraps>
...
801060d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801060da:	e9 3f f6 ff ff       	jmp    8010571e <alltraps>
...
801060e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060e6:	e9 33 f6 ff ff       	jmp    8010571e <alltraps>
...
801060ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060f2:	e9 27 f6 ff ff       	jmp    8010571e <alltraps>
...
801060f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060fe:	e9 1b f6 ff ff       	jmp    8010571e <alltraps>
...
80106105:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010610a:	e9 0f f6 ff ff       	jmp    8010571e <alltraps>
...
80106111:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106116:	e9 03 f6 ff ff       	jmp    8010571e <alltraps>
...
8010611d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106122:	e9 f7 f5 ff ff       	jmp    8010571e <alltraps>
...
80106129:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010612e:	e9 eb f5 ff ff       	jmp    8010571e <alltraps>
...
80106135:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010613a:	e9 df f5 ff ff       	jmp    8010571e <alltraps>
...
80106141:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106146:	e9 d3 f5 ff ff       	jmp    8010571e <alltraps>
...
8010614d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106152:	e9 c7 f5 ff ff       	jmp    8010571e <alltraps>
...
80106159:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010615e:	e9 bb f5 ff ff       	jmp    8010571e <alltraps>
...
80106165:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010616a:	e9 af f5 ff ff       	jmp    8010571e <alltraps>
...
80106171:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106176:	e9 a3 f5 ff ff       	jmp    8010571e <alltraps>
...
8010617d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106182:	e9 97 f5 ff ff       	jmp    8010571e <alltraps>
...
80106189:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010618e:	e9 8b f5 ff ff       	jmp    8010571e <alltraps>
...
80106195:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010619a:	e9 7f f5 ff ff       	jmp    8010571e <alltraps>
...
801061a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801061a6:	e9 73 f5 ff ff       	jmp    8010571e <alltraps>
...
801061ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801061b2:	e9 67 f5 ff ff       	jmp    8010571e <alltraps>
...
801061b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801061be:	e9 5b f5 ff ff       	jmp    8010571e <alltraps>
...
801061c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801061ca:	e9 4f f5 ff ff       	jmp    8010571e <alltraps>
...
801061d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801061d6:	e9 43 f5 ff ff       	jmp    8010571e <alltraps>
...
801061dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801061e2:	e9 37 f5 ff ff       	jmp    8010571e <alltraps>
...
801061e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801061ee:	e9 2b f5 ff ff       	jmp    8010571e <alltraps>
...
801061f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061fa:	e9 1f f5 ff ff       	jmp    8010571e <alltraps>
...
80106201:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106206:	e9 13 f5 ff ff       	jmp    8010571e <alltraps>
...
8010620d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106212:	e9 07 f5 ff ff       	jmp    8010571e <alltraps>
...
80106219:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010621e:	e9 fb f4 ff ff       	jmp    8010571e <alltraps>
...
80106225:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010622a:	e9 ef f4 ff ff       	jmp    8010571e <alltraps>
...
80106231:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106236:	e9 e3 f4 ff ff       	jmp    8010571e <alltraps>
...
8010623d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106242:	e9 d7 f4 ff ff       	jmp    8010571e <alltraps>
...
80106249:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010624e:	e9 cb f4 ff ff       	jmp    8010571e <alltraps>
...
80106255:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010625a:	e9 bf f4 ff ff       	jmp    8010571e <alltraps>
...
80106261:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106266:	e9 b3 f4 ff ff       	jmp    8010571e <alltraps>
...
8010626d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106272:	e9 a7 f4 ff ff       	jmp    8010571e <alltraps>
...
80106279:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010627e:	e9 9b f4 ff ff       	jmp    8010571e <alltraps>
...
80106285:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010628a:	e9 8f f4 ff ff       	jmp    8010571e <alltraps>
...
80106291:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106296:	e9 83 f4 ff ff       	jmp    8010571e <alltraps>
...
8010629d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801062a2:	e9 77 f4 ff ff       	jmp    8010571e <alltraps>
...
801062a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801062ae:	e9 6b f4 ff ff       	jmp    8010571e <alltraps>
...
801062b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801062ba:	e9 5f f4 ff ff       	jmp    8010571e <alltraps>
...
801062c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801062c6:	e9 53 f4 ff ff       	jmp    8010571e <alltraps>
...
801062cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801062d2:	e9 47 f4 ff ff       	jmp    8010571e <alltraps>
...
801062d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801062de:	e9 3b f4 ff ff       	jmp    8010571e <alltraps>
...
801062e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801062ea:	e9 2f f4 ff ff       	jmp    8010571e <alltraps>
...
801062f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062f6:	e9 23 f4 ff ff       	jmp    8010571e <alltraps>
...
801062fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106302:	e9 17 f4 ff ff       	jmp    8010571e <alltraps>
...
80106309:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010630e:	e9 0b f4 ff ff       	jmp    8010571e <alltraps>
...
80106315:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010631a:	e9 ff f3 ff ff       	jmp    8010571e <alltraps>
...
80106321:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106326:	e9 f3 f3 ff ff       	jmp    8010571e <alltraps>
...
8010632d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106332:	e9 e7 f3 ff ff       	jmp    8010571e <alltraps>
...
80106339:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010633e:	e9 db f3 ff ff       	jmp    8010571e <alltraps>
...
80106345:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010634a:	e9 cf f3 ff ff       	jmp    8010571e <alltraps>
...
80106351:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106356:	e9 c3 f3 ff ff       	jmp    8010571e <alltraps>
...
8010635d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106362:	e9 b7 f3 ff ff       	jmp    8010571e <alltraps>
...
80106369:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010636e:	e9 ab f3 ff ff       	jmp    8010571e <alltraps>
...
80106375:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010637a:	e9 9f f3 ff ff       	jmp    8010571e <alltraps>
...
80106381:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106386:	e9 93 f3 ff ff       	jmp    8010571e <alltraps>
...
8010638d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106392:	e9 87 f3 ff ff       	jmp    8010571e <alltraps>
...
80106399:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010639e:	e9 7b f3 ff ff       	jmp    8010571e <alltraps>
...
801063a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801063aa:	e9 6f f3 ff ff       	jmp    8010571e <alltraps>
...
801063b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801063b6:	e9 63 f3 ff ff       	jmp    8010571e <alltraps>
...
801063bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801063c2:	e9 57 f3 ff ff       	jmp    8010571e <alltraps>
...
801063c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801063ce:	e9 4b f3 ff ff       	jmp    8010571e <alltraps>
...
801063d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801063da:	e9 3f f3 ff ff       	jmp    8010571e <alltraps>
...
801063e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801063e6:	e9 33 f3 ff ff       	jmp    8010571e <alltraps>
...
801063ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063f2:	e9 27 f3 ff ff       	jmp    8010571e <alltraps>
...
801063f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063fe:	e9 1b f3 ff ff       	jmp    8010571e <alltraps>
...
80106405:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010640a:	e9 0f f3 ff ff       	jmp    8010571e <alltraps>
...
80106411:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106416:	e9 03 f3 ff ff       	jmp    8010571e <alltraps>
...
8010641d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106422:	e9 f7 f2 ff ff       	jmp    8010571e <alltraps>
...
80106429:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010642e:	e9 eb f2 ff ff       	jmp    8010571e <alltraps>
...
80106435:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010643a:	e9 df f2 ff ff       	jmp    8010571e <alltraps>
...
80106441:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106446:	e9 d3 f2 ff ff       	jmp    8010571e <alltraps>
...
8010644d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106452:	e9 c7 f2 ff ff       	jmp    8010571e <alltraps>
...
80106459:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010645e:	e9 bb f2 ff ff       	jmp    8010571e <alltraps>
...
80106465:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010646a:	e9 af f2 ff ff       	jmp    8010571e <alltraps>
...
80106471:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106476:	e9 a3 f2 ff ff       	jmp    8010571e <alltraps>
...
8010647d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106482:	e9 97 f2 ff ff       	jmp    8010571e <alltraps>
...
80106489:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010648e:	e9 8b f2 ff ff       	jmp    8010571e <alltraps>
...
80106495:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010649a:	e9 7f f2 ff ff       	jmp    8010571e <alltraps>
...
801064a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801064a6:	e9 73 f2 ff ff       	jmp    8010571e <alltraps>
...
801064ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801064b2:	e9 67 f2 ff ff       	jmp    8010571e <alltraps>
...
801064b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801064be:	e9 5b f2 ff ff       	jmp    8010571e <alltraps>
...
801064c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801064ca:	e9 4f f2 ff ff       	jmp    8010571e <alltraps>
...
801064d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801064d6:	e9 43 f2 ff ff       	jmp    8010571e <alltraps>
...
801064dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801064e2:	e9 37 f2 ff ff       	jmp    8010571e <alltraps>
...
801064e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801064ee:	e9 2b f2 ff ff       	jmp    8010571e <alltraps>
...
801064f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064fa:	e9 1f f2 ff ff       	jmp    8010571e <alltraps>
...
80106501:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106506:	e9 13 f2 ff ff       	jmp    8010571e <alltraps>
...
8010650d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106512:	e9 07 f2 ff ff       	jmp    8010571e <alltraps>
...
80106519:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010651e:	e9 fb f1 ff ff       	jmp    8010571e <alltraps>
...
80106525:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010652a:	e9 ef f1 ff ff       	jmp    8010571e <alltraps>
...
80106531:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106536:	e9 e3 f1 ff ff       	jmp    8010571e <alltraps>
...
8010653d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106542:	e9 d7 f1 ff ff       	jmp    8010571e <alltraps>
...
80106549:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010654e:	e9 cb f1 ff ff       	jmp    8010571e <alltraps>
...
80106555:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010655a:	e9 bf f1 ff ff       	jmp    8010571e <alltraps>
...
80106561:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106566:	e9 b3 f1 ff ff       	jmp    8010571e <alltraps>
...
8010656d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106572:	e9 a7 f1 ff ff       	jmp    8010571e <alltraps>
...
80106579:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010657e:	e9 9b f1 ff ff       	jmp    8010571e <alltraps>
...
80106585:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010658a:	e9 8f f1 ff ff       	jmp    8010571e <alltraps>
...
80106591:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106596:	e9 83 f1 ff ff       	jmp    8010571e <alltraps>
...
8010659d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801065a2:	e9 77 f1 ff ff       	jmp    8010571e <alltraps>
...
801065a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801065ae:	e9 6b f1 ff ff       	jmp    8010571e <alltraps>
...
801065b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801065ba:	e9 5f f1 ff ff       	jmp    8010571e <alltraps>
...
801065c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801065c6:	e9 53 f1 ff ff       	jmp    8010571e <alltraps>
...
801065cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801065d2:	e9 47 f1 ff ff       	jmp    8010571e <alltraps>
...
801065d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801065de:	e9 3b f1 ff ff       	jmp    8010571e <alltraps>
...
801065e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801065ea:	e9 2f f1 ff ff       	jmp    8010571e <alltraps>
...
801065f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065f6:	e9 23 f1 ff ff       	jmp    8010571e <alltraps>
...
801065fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106602:	e9 17 f1 ff ff       	jmp    8010571e <alltraps>
...
80106609:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010660e:	e9 0b f1 ff ff       	jmp    8010571e <alltraps>
...
80106615:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010661a:	e9 ff f0 ff ff       	jmp    8010571e <alltraps>
...
80106621:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106626:	e9 f3 f0 ff ff       	jmp    8010571e <alltraps>
...
8010662d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106632:	e9 e7 f0 ff ff       	jmp    8010571e <alltraps>
...
80106639:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010663e:	e9 db f0 ff ff       	jmp    8010571e <alltraps>
...
80106645:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010664a:	e9 cf f0 ff ff       	jmp    8010571e <alltraps>
...
80106651:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106656:	e9 c3 f0 ff ff       	jmp    8010571e <alltraps>
...
8010665d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106662:	e9 b7 f0 ff ff       	jmp    8010571e <alltraps>
...
801066ca:	e8 c1 dd ff ff       	call   80104490 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010676d:	68 50 78 10 80       	push   $0x80107850
...
8010679c:	73 60                	jae    801067fe <deallocuvm.part.0+0x7e>
...
801067b5:	74 52                	je     80106809 <deallocuvm.part.0+0x89>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
...
801067dd:	73 1f                	jae    801067fe <deallocuvm.part.0+0x7e>
    pte = walkpgdir(pgdir, (char*)a, 0);
...
801067ec:	75 ba                	jne    801067a8 <deallocuvm.part.0+0x28>
      a += (NPTENTRIES - 1) * PGSIZE;
801067ee:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
...
801067fa:	39 f3                	cmp    %esi,%ebx
801067fc:	72 e1                	jb     801067df <deallocuvm.part.0+0x5f>
      kfree(v);
      *pte = 0;
    }
  }
...
80106801:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106804:	5b                   	pop    %ebx
80106805:	5e                   	pop    %esi
80106806:	5f                   	pop    %edi
80106807:	5d                   	pop    %ebp
...
8010680c:	68 12 72 10 80       	push   $0x80107212
80106811:	e8 5a 9b ff ff       	call   80100370 <panic>
...
80106826:	83 ec 14             	sub    $0x14,%esp
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
80106829:	e8 b2 be ff ff       	call   801026e0 <cpunum>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010682e:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80106834:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
80106839:	8d 90 a0 27 11 80    	lea    -0x7feed860(%eax),%edx
8010683f:	c6 80 1d 28 11 80 9a 	movb   $0x9a,-0x7feed7e3(%eax)
80106846:	c6 80 1e 28 11 80 cf 	movb   $0xcf,-0x7feed7e2(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010684d:	c6 80 25 28 11 80 92 	movb   $0x92,-0x7feed7db(%eax)
80106854:	c6 80 26 28 11 80 cf 	movb   $0xcf,-0x7feed7da(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010685b:	66 89 4a 78          	mov    %cx,0x78(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010685f:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106864:	66 89 5a 7a          	mov    %bx,0x7a(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106868:	66 89 8a 80 00 00 00 	mov    %cx,0x80(%edx)
8010686f:	31 db                	xor    %ebx,%ebx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106871:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106876:	66 89 9a 82 00 00 00 	mov    %bx,0x82(%edx)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010687d:	66 89 8a 90 00 00 00 	mov    %cx,0x90(%edx)
80106884:	31 db                	xor    %ebx,%ebx
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106886:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010688b:	66 89 9a 92 00 00 00 	mov    %bx,0x92(%edx)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106892:	31 db                	xor    %ebx,%ebx
80106894:	66 89 8a 98 00 00 00 	mov    %cx,0x98(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
8010689b:	8d 88 54 28 11 80    	lea    -0x7feed7ac(%eax),%ecx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068a1:	66 89 9a 9a 00 00 00 	mov    %bx,0x9a(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801068a8:	31 db                	xor    %ebx,%ebx
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068aa:	c6 80 35 28 11 80 fa 	movb   $0xfa,-0x7feed7cb(%eax)
801068b1:	c6 80 36 28 11 80 cf 	movb   $0xcf,-0x7feed7ca(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801068b8:	66 89 9a 88 00 00 00 	mov    %bx,0x88(%edx)
801068bf:	66 89 8a 8a 00 00 00 	mov    %cx,0x8a(%edx)
801068c6:	89 cb                	mov    %ecx,%ebx
801068c8:	c1 e9 18             	shr    $0x18,%ecx
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068cb:	c6 80 3d 28 11 80 f2 	movb   $0xf2,-0x7feed7c3(%eax)
801068d2:	c6 80 3e 28 11 80 cf 	movb   $0xcf,-0x7feed7c2(%eax)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801068d9:	88 8a 8f 00 00 00    	mov    %cl,0x8f(%edx)
801068df:	c6 80 2d 28 11 80 92 	movb   $0x92,-0x7feed7d3(%eax)
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
801068e6:	b9 37 00 00 00       	mov    $0x37,%ecx
801068eb:	c6 80 2e 28 11 80 c0 	movb   $0xc0,-0x7feed7d2(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
801068f2:	05 10 28 11 80       	add    $0x80112810,%eax
801068f7:	66 89 4d f2          	mov    %cx,-0xe(%ebp)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
  ...
  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
801068fb:	c1 eb 10             	shr    $0x10,%ebx
  pd[1] = (uint)p;
...
80106902:	c1 e8 10             	shr    $0x10,%eax
  ...
  c = &cpus[cpunum()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106905:	c6 42 7c 00          	movb   $0x0,0x7c(%edx)
80106909:	c6 42 7f 00          	movb   $0x0,0x7f(%edx)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010690d:	c6 82 84 00 00 00 00 	movb   $0x0,0x84(%edx)
80106914:	c6 82 87 00 00 00 00 	movb   $0x0,0x87(%edx)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010691b:	c6 82 94 00 00 00 00 	movb   $0x0,0x94(%edx)
80106922:	c6 82 97 00 00 00 00 	movb   $0x0,0x97(%edx)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106929:	c6 82 9c 00 00 00 00 	movb   $0x0,0x9c(%edx)
80106930:	c6 82 9f 00 00 00 00 	movb   $0x0,0x9f(%edx)

  // Map cpu and proc -- these are private per cpu.
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80106937:	88 9a 8c 00 00 00    	mov    %bl,0x8c(%edx)
8010693d:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80106941:	8d 45 f2             	lea    -0xe(%ebp),%eax
80106944:	0f 01 10             	lgdtl  (%eax)
}
...
80106947:	b8 18 00 00 00       	mov    $0x18,%eax
8010694c:	8e e8                	mov    %eax,%gs
  ...
  cpu = c;
  proc = 0;
8010694e:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80106955:	00 00 00 00 
  ...
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpunum()];
80106959:	65 89 15 00 00 00 00 	mov    %edx,%gs:0x0
  loadgs(SEG_KCPU << 3);
...
80106960:	83 c4 14             	add    $0x14,%esp
80106963:	5b                   	pop    %ebx
80106964:	5d                   	pop    %ebp
80106965:	c3                   	ret    
...
80106975:	e8 06 bb ff ff       	call   80102480 <kalloc>
8010697a:	85 c0                	test   %eax,%eax
8010697c:	74 52                	je     801069d0 <setupkvm+0x60>
    return 0;
  memset(pgdir, 0, PGSIZE);
8010697e:	83 ec 04             	sub    $0x4,%esp
80106981:	89 c6                	mov    %eax,%esi
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106983:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  pde_t *pgdir;
  struct kmap *k;
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
80106988:	68 00 10 00 00       	push   $0x1000
8010698d:	6a 00                	push   $0x0
8010698f:	50                   	push   %eax
80106990:	e8 fb da ff ff       	call   80104490 <memset>
...
8010699b:	8b 4b 08             	mov    0x8(%ebx),%ecx
8010699e:	83 ec 08             	sub    $0x8,%esp
801069a1:	8b 13                	mov    (%ebx),%edx
801069a3:	ff 73 0c             	pushl  0xc(%ebx)
801069a6:	50                   	push   %eax
801069a7:	29 c1                	sub    %eax,%ecx
801069a9:	89 f0                	mov    %esi,%eax
801069ab:	e8 40 fd ff ff       	call   801066f0 <mappages>
801069b0:	83 c4 10             	add    $0x10,%esp
801069b3:	85 c0                	test   %eax,%eax
801069b5:	78 19                	js     801069d0 <setupkvm+0x60>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801069b7:	83 c3 10             	add    $0x10,%ebx
801069ba:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
801069c0:	75 d6                	jne    80106998 <setupkvm+0x28>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
...
801069d0:	8d 65 f8             	lea    -0x8(%ebp),%esp
{
  pde_t *pgdir;
  struct kmap *k;
...
801069e3:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801069e6:	e8 85 ff ff ff       	call   80106970 <setupkvm>
801069eb:	a3 24 55 11 80       	mov    %eax,0x80115524
}
...
80106a00 <switchkvm>:
80106a00:	a1 24 55 11 80       	mov    0x80115524,%eax
...
80106a24:	83 ec 04             	sub    $0x4,%esp
80106a27:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80106a2a:	e8 91 d9 ff ff       	call   801043c0 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106a2f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106a35:	b9 67 00 00 00       	mov    $0x67,%ecx
80106a3a:	8d 50 08             	lea    0x8(%eax),%edx
80106a3d:	66 89 88 a0 00 00 00 	mov    %cx,0xa0(%eax)
80106a44:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80106a4b:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106a52:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
80106a59:	89 d1                	mov    %edx,%ecx
80106a5b:	c1 ea 18             	shr    $0x18,%edx
80106a5e:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
80106a64:	ba 10 00 00 00       	mov    $0x10,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106a69:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
80106a6c:	66 89 50 10          	mov    %dx,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106a70:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106a77:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
...
80106a7d:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
{
  ...
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106a82:	8b 52 08             	mov    0x8(%edx),%edx
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106a85:	66 89 48 6e          	mov    %cx,0x6e(%eax)
{
  ...
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106a89:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106a8f:	89 50 0c             	mov    %edx,0xc(%eax)
}
...
80106a92:	b8 30 00 00 00       	mov    $0x30,%eax
80106a97:	0f 00 d8             	ltr    %ax
  ...
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
80106a9a:	8b 43 04             	mov    0x4(%ebx),%eax
80106a9d:	85 c0                	test   %eax,%eax
80106a9f:	74 11                	je     80106ab2 <switchuvm+0x92>
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106aa1:	05 00 00 00 80       	add    $0x80000000,%eax
80106aa6:	0f 22 d8             	mov    %eax,%cr3
...
80106aac:	c9                   	leave  
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106aad:	e9 3e d9 ff ff       	jmp    801043f0 <popcli>
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
...
80106ab5:	68 56 78 10 80       	push   $0x80107856
...
80106aef:	e8 9c d9 ff ff       	call   80104490 <memset>
...
80106b09:	e8 e2 fb ff ff       	call   801066f0 <mappages>
  memmove(mem, init, sz);
...
80106b20:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106b21:	e9 1a da ff ff       	jmp    80104540 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106b29:	68 6a 78 10 80       	push   $0x8010786a
...
80106b83:	e8 e8 fa ff ff       	call   80106670 <walkpgdir>
...
80106bb1:	e8 6a ad ff ff       	call   80101920 <readi>
...
80106bdd:	68 84 78 10 80       	push   $0x80107884
...
80106bea:	68 28 79 10 80       	push   $0x80107928
...
80106c43:	e8 48 d8 ff ff       	call   80104490 <memset>
...
80106c5d:	e8 8e fa ff ff       	call   801066f0 <mappages>
...
80106c81:	68 a2 78 10 80       	push   $0x801078a2
...
80106cb3:	68 ba 78 10 80       	push   $0x801078ba
...
80106ccd:	e8 ae fa ff ff       	call   80106780 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
80106d10:	5d                   	pop    %ebp
80106d11:	e9 6a fa ff ff       	jmp    80106780 <deallocuvm.part.0>
...
80106d49:	e8 32 fa ff ff       	call   80106780 <deallocuvm.part.0>
...
80106d9c:	68 d6 78 10 80       	push   $0x801078d6
...
80106dbe:	e8 ad f8 ff ff       	call   80106670 <walkpgdir>
  if(pte == 0)
...
80106dcf:	68 e7 78 10 80       	push   $0x801078e7
...
80106de6:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106de9:	e8 82 fb ff ff       	call   80106970 <setupkvm>
...
80106e20:	e8 1b d7 ff ff       	call   80104540 <memmove>
...
80106e3b:	e8 b0 f8 ff ff       	call   801066f0 <mappages>
...
80106e59:	e8 12 f8 ff ff       	call   80106670 <walkpgdir>
...
80106e74:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106e7a:	e8 01 b6 ff ff       	call   80102480 <kalloc>
...
80106eb2:	68 0b 79 10 80       	push   $0x8010790b
...
80106ebf:	68 f1 78 10 80       	push   $0x801078f1
...
80106ede:	e8 8d f7 ff ff       	call   80106670 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106f4f:	e8 ec d5 ff ff       	call   80104540 <memmove>
    len -= n;
    buf += n;
